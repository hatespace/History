...
public class Philosophy_pageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_philosophy_page);
        ...
        resetImg();
        phi.setImageResource(R.drawable.zhexue);
        ...
        ListItemAdapter listItemAdapter = new ListItemAdapter(Philosophy_pageActivity.this,
